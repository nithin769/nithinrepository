...
\begin{enumerate}
    ...
    \item $\begin{cases} 1,\hfill 0<x\leq\frac{3\pi}{4} \\
                2sin\frac{2}{9}x,\hfill \frac{3\pi}{4}<x<\pi
    
\end{cases}$
    \item $\begin{cases} xsinx,\hfill 0<x\leq\frac{\pi}{2} \\
                  \frac{\pi}{2}sin(\pi+x),\hfill \frac{\pi}{2}<x<\pi \\ 
\end{cases}$
\end{enumerate}
